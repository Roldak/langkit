...
with Dependz_Support.Adalog.Debug; use Dependz_Support.Adalog.Debug;
with Dependz_Support.Adalog.Pure_Relations;
use Dependz_Support.Adalog.Pure_Relations;

package body Dependz_Support.Adalog.Operations is

   package Rel_Arrays_Utils is new Dependz_Support.Array_Utils
...
end Dependz_Support.Adalog.Operations;
