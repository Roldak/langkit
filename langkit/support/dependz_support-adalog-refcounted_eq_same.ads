...
with Dependz_Support.Adalog.Refcounted_Logic_Ref;
with Dependz_Support.Adalog.Unify;
with Dependz_Support.Adalog.Unify_LR;

generic
   type LR_Type is private;
   with function Element_Image (E : LR_Type) return String is <>;
package Dependz_Support.Adalog.Refcounted_Eq_Same is
...
end Dependz_Support.Adalog.Refcounted_Eq_Same;
