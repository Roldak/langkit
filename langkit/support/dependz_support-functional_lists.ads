...
private with Dependz_Support.Generic_Bump_Ptr;
...
--       procedure Main is
--          package Int_Lists
--          is new Dependz_Support.Functional_Lists (Integer);
--          use Int_Lists;
--
--          A : List := Create;
...
generic
   type T is private;
package Dependz_Support.Functional_Lists is
...
private
   ...
   package Bump is new Dependz_Support.Generic_Bump_Ptr (T'Size * 16);
...
end Dependz_Support.Functional_Lists;
