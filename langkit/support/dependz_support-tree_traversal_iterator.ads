...
generic
   ...
   with package Iterators is new Dependz_Support.Iterators
     (Node_Type, Node_Array);

package Dependz_Support.Tree_Traversal_Iterator is
...
private
   ...
   package Natural_Vectors is new Dependz_Support.Vectors (Natural);
...
end Dependz_Support.Tree_Traversal_Iterator;
