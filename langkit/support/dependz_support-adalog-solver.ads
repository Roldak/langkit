...
with Dependz_Support.Adalog.Logic_Var;
with Dependz_Support.Vectors;

generic
   with package Logic_Vars
     is new Dependz_Support.Adalog.Logic_Var (<>);
package Dependz_Support.Adalog.Solver is
   ...
   package Relation_Vectors is new Dependz_Support.Vectors (Relation);
...
private
   ...
   is new Dependz_Support.Vectors (Var);
