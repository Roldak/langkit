...
package Dependz_Support.Adalog.Generic_Main_Support is

   package Refs is new Dependz_Support.Adalog.Logic_Ref
     (T, Element_Image => Image);
   function Create (Name : String) return Refs.Raw_Var;

   package T_Solver is new Dependz_Support.Adalog.Solver
     (Refs.Raw_Logic_Var);
...
end Dependz_Support.Adalog.Generic_Main_Support;
