...
package Dependz_Support.Adalog.Refcounted_Logic_Ref is

   procedure Inc_Ref (E : Element_Type) is null;
   procedure Dec_Ref (E : in out Element_Type) is null;

   package LRef is new Dependz_Support.Adalog.Logic_Ref
...
end Dependz_Support.Adalog.Refcounted_Logic_Ref;
