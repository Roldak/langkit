...
with Dependz_Support.Adalog.Relations;
use Dependz_Support.Adalog.Relations;

package Dependz_Support.Adalog.Predicates is
...
end Dependz_Support.Adalog.Predicates;
