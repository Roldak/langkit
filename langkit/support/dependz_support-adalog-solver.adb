...
package body Dependz_Support.Adalog.Solver is
   ...
   is new Dependz_Support.Vectors (Atomic_Relation);
   ...
   function Image
   is new Dependz_Support.Images.Array_Image
     (Atomic_Relation,
      Positive,
   ...
   is new Dependz_Support.Functional_Lists (Any_Rel);
   ...
   is new Dependz_Support.Functional_Lists (Atomic_Relation);

   package Var_Ids_To_Atoms_Vectors
   is new Dependz_Support.Vectors (Atomic_Relation_Lists.List);
   ...
   package Atom_Lists
   is new Dependz_Support.Functional_Lists (Atom_And_Index);
   package Atom_Lists_Vectors
   is new Dependz_Support.Vectors (Atom_Lists.List);
...
end Dependz_Support.Adalog.Solver;
