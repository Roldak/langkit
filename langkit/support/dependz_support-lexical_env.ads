...
generic
   ...
   with package Symbols is new Dependz_Support.Symbols
...
package Dependz_Support.Lexical_Env is
   ...
   Me : constant Traces.Trace_Handle :=
     Traces.Create ("DEPENDZ.LEXICAL_ENV", Traces.From_Config);

   Rec : constant Traces.Trace_Handle :=
     Traces.Create ("DEPENDZ.LEXICAL_ENV.RECURSIVE", Traces.From_Config);

   Caches_Trace : constant Traces.Trace_Handle :=
     Traces.Create ("DEPENDZ.LEXICAL_ENV.CACHES", Traces.From_Config);
   ...
   package Env_Rebindings_Vectors is new Dependz_Support.Vectors
     (Env_Rebindings);
   ...
   package Entity_Vectors is new Dependz_Support.Vectors
   ...
   package Referenced_Envs_Vectors is new Dependz_Support.Vectors
     (Referenced_Env);
   ...
   package Lookup_Result_Item_Vectors is new Dependz_Support.Vectors
   ...
   package Lexical_Env_Vectors is new Dependz_Support.Vectors (Lexical_Env);
   ...
   package Internal_Map_Node_Vectors is new Dependz_Support.Vectors
     (Internal_Map_Node);
...
end Dependz_Support.Lexical_Env;
